...
window.__STATIC_ARTICLES__ = [
  ...
  {
    "id": "DigitLearn_017",
    "title": "AI 評測分數很好，就能上線嗎？先測高風險錯誤與停用流程",
  ...
  },
  {
    ...
    "lead": "中風破壞大腦下行抑制神經路徑。「手很緊」包含動態痙攣、靜態攣縮與主動肌力缺乏；釐清是為了清潔、穿衣還是動作使用，拉筋、副木與肉毒處置才有精準方向。",
  ...
  {
    "id": "MotorRehab_009",
    "title": "中風後走路訓練要練多久、練多快？把強度放回生活目標",
  ...
  },
  {
    ...
    "imageUrl": "https://images.unsplash.com/photo-1758656321519-02fb5f48dc7e?auto=format&fit=crop&w=1200&q=80",
    "tags": [
      "視覺復健"
    ],
