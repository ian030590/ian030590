...
window.__STATIC_ARTICLES__ = [
  ...
  },
  {
    ...
    "lead": "放大不只是把字體變大。低視能復健依賴四大放大途徑：尺寸放大、距離放大、透鏡角度放大與投影放大。搞懂屈光度、焦距與視場（Field of View）的物理消長，並結合黃斑部病變、青光眼與糖尿病視網膜病變的視野特徵，才能找出省力、不易疲勞的光學代償方案。",
  ...
  },
  {
    ...
    "lead": "糖尿病視網膜病變常導致視力驟降與散在性暗點，此時精準施打胰島素與辨識多重慢性病藥物成了生死攸關的挑戰。專科職能治療師結合理論與糖尿病衛教，運用聽覺喀嗒計數、針筒放大定位套夾、語音血糖機與足部檢視鏡，預防低血糖急症與相關併發症。",
