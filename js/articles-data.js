...
window.__STATIC_ARTICLES__ = [
  ...
  },
  {
    ...
    "lead": "大語言模型機率生成天生具備幻覺。檢索增強生成（RAG）增加外部事實依據，但若檢索斷章取義或語義漂移仍會給出致命處方；分開檢查找得對不對與文字忠不忠實，才是臨床核對之道。",
    "imageUrl": "https://images.unsplash.com/photo-1576091160550-2173dba999ef?auto=format&fit=crop&w=1200&q=80",
    "tags": [
      "數位學習",
      "AI應用"
  ...
  },
  {
    ...
    "lead": "平均準確率 90% 往往隱藏致命低機率失誤。遵循 TRIPOD-LLM 與 NIST AI RMF，評測高風險遺漏、事實忠實度與版本漂移，並備妥一秒切回人工流程，方為導入正道。",
    "imageUrl": "https://images.unsplash.com/photo-1666886573264-38075cc56104?auto=format&fit=crop&w=1200&q=80",
    "tags": [
      "數位學習",
      "AI應用"
  ...
  },
  {
    ...
    "lead": "中風破壞腦幹與皮質延髓吞嚥反射神經。沒有嗆咳不能排除致命的「無聲吸入」；入院 24 小時內結構化篩檢、必要時儀器檢查與飲食質地分級，是守護氣道安全的防線。",
    "imageUrl": "https://images.unsplash.com/photo-1645005513713-9e2b92a687d3?auto=format&fit=crop&w=1200&q=80",
    "tags": [
      "中風復健",
      "動作復健"
  ...
  },
  {
    ...
    "lead": "工傷初期過度臥床只會加速生理去適應與心理依賴。ACOEM 實證指引指出，排除紅旗徵兆後及早建立正向預期、以相對休息取代完全制動，並運用能耐架構推進漸進復工，才是阻斷慢性失能的關鍵。",
  ...
  },
  {
    ...
    "lead": "高對比黑白視力表只反映眼睛最佳光學極限。對比敏感度、視野暗點與閱讀速度放在一起看，才能精準找出真實生活中看不清的癥結。",
